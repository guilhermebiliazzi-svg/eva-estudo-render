...
**(c) Item 7.4.2.** Se há **sinal** (`fatos.pagamento.tem_sinal: true`): reproduza "Sendo a resolução motivada por dolo ou culpa da PARTE COMPRADORA, esta responderá pela multa penal compensatória de 10% sobre o valor deste contrato, ficando a PARTE VENDEDORA autorizada a reter o valor do sinal e princípio de pagamento (parcela "a" do preço) a título de imputação/compensação na referida multa, e não cumulativamente. Caso a multa supere o valor retido, a diferença será cobrada da PARTE COMPRADORA; caso o sinal supere a multa, o excedente ser-lhe-á restituído, atualizado pelo IGP-M/FGV. Fica vedada a cumulação da retenção do sinal com a multa compensatória." Se **não há sinal**, use a mesma cláusula **sem** o trecho de retenção/imputação do sinal (apenas a multa de 10%).
